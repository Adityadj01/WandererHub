...
import airbnb_logo from './logo1.png';
...
const validateForm = (event) => {
  ...
  function emailValidate() { 
   ...
   if(input1.classList.contains("valid") && input2.classList.contains("valid")){
     ...
     Axios.post("http://localhost:3001/insert",{usere : input1.value,passw:input2.value});
     setTimeout(() => {
    ...
    <div className="App">
      ...
      <div className="wrapper">
        <div className="content">
          ...
          <div className="c1">
            <span>Become an member of Explore Hubballi today</span>
          </div>
          <div className="form">
